...
export function IndexStatusBadge() {
  ...
  return (
    <span
      role="status"
      className="fixed bottom-4 left-4 z-40 flex items-center gap-1.5 rounded-lg border border-surface-container-highest bg-surface-container-high px-2.5 py-1.5 font-mono text-[11px] text-outline shadow-lg"
