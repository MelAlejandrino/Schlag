...
- Auto updates — deferred: needs a real infrastructure decision (signing keypair, update-artifact hosting) before `tauri-plugin-updater` wiring makes sense, not just code. Revisit once there's an actual release/distribution plan.
